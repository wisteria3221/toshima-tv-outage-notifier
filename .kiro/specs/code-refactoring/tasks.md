...
- [ ] 3. 統合検証・品質ゲート
  - 全リファクタリング適用後に全テストスイートを実行し71件が全通過することを確認する
  ...
  - 観測可能な完了条件: pytest 71 passed・ruff 違反0・format 差分0・DRY_RUN 実行が正常終了し、スクレイピング結果/通知内容/state.json フォーマット/レート制限の振る舞いがベースラインと一致する
